...
8. **`readonly_client()` lands at end of Week 3** (psycopg + `SUPABASE_READONLY_PASSWORD`); Week 4's SQL agent depends on it. Don't import it before W3.5 ships. Original PRD said "Week 5"; superseded by `docs/superpowers/specs/2026-04-26-v1-roadmap-r2-reprioritization.md`.
